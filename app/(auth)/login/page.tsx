...
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col items-center justify-center gap-16 pb-16 pt-12 sm:gap-20 sm:pt-20">
      <section
        dir={direction}
        className={`${alignment} flex w-full max-w-sm flex-col gap-6`}
      >
