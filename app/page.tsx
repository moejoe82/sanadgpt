  ...
  return (
    <PageLayout variant="gradient-sanadgpt">
      ...
      <section className="relative overflow-hidden min-h-screen">
        ...
        <Container
          size="lg"
          className="relative z-10 flex min-h-[100svh] flex-col items-center justify-center py-12 md:py-20"
        >
              ...
              return (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    >
                      <div className="inline-flex flex-shrink-0 items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-[#9c7adf]/30 to-[#d8c1ff]/30 group-hover:from-[#b68df1]/40 group-hover:to-[#f4f1d0]/40 transition-all">
                      ...
                      <div className="flex-1">
                        ...
                        <Body
                          size="sm"
                          className={cn(
                            "text-[#f4f1d0] opacity-80 group-hover:opacity-100 transition-opacity leading-relaxed",
